...
export default function CreateWorkshopModal({
  ...
  const [meetingType, setMeetingType] = useState<"schedule" | "live">(
    "schedule"
  );
  ...
  const [currentWorkshopId, setCurrentWorkshopId] = useState<string | null>(
    null
  );
  const [currentWorkshopTitle, setCurrentWorkshopTitle] = useState("");
  const [currentWorkshopDescription, setCurrentWorkshopDescription] =
    useState("");
    ...
    <>
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogTrigger asChild>
          <Button className="gap-2 bg-teal-700 hover:bg-teal-700/80 text-white shadow-sm hover:shadow-[0_0_20px_rgba(39,88,79,0.2)]">
            <Plus size={16} />
            Schedule Conclave
          </Button>
        </DialogTrigger>
        <DialogContent className="sm:max-w-[500px] bg-card border-teal-700/30 text-foreground">
          <DialogHeader>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <RadioGroup
                value={meetingType}
                onValueChange={(value: "schedule" | "live") =>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                className="bg-background border-teal-700/30 focus:ring-teal-700"
                required
              />
            </div>
            ...
            <div className="flex justify-end gap-3 pt-4">
              ...
              <Button
                type="submit"
                disabled={loading}
                className="bg-teal-700 hover:bg-teal-700/90 text-white"
              >
                {loading ? (
