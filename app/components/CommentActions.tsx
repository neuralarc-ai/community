    ...
    <div className="flex items-center space-x-4 text-xs text-gray-500">
      ...
      <div className="flex items-center space-x-1">
        <button
          ...
          className={`p-1 rounded-md hover:bg-gray-200 transition-colors duration-150 ease-in-out
            ${currentUserVote === 1 ? 'text-blue-600' : ''}
          `}
          aria-label="Upvote"
        >
      ...
      <button
        ...
        className="flex items-center space-x-1 hover:text-gray-700 transition-colors duration-150 ease-in-out"
      >
